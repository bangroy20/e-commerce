					...
					<div class="card mb-3">
						...
						<div class="card-body">
							...
							<div class="form-group">
								...
								<select name="tokoId" id="tokoId" class="custom-select browser-default" required>
						...
						<table class="table table-bordered table-hover mb-0">
							...
							<tbody>
								...
								while ($row = mysqli_fetch_assoc($result)) {
									...
									$menuTokoId = $row['menuTokoId'];

									echo '<tr>
                                            <td class="text-center">' . $menuTokoId . '</td>
                                            <td>
                                                <img src="/e-commerce/img/menu-' . $menuId . '.jpg" alt="image for this item" width="150px" height="150px">
                                            </td>
                                            <td>
					...
					<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
						<div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
							...
							<div class="form-group col-md-4">
								<img src="/e-commerce/img/menu-<?php echo $menuId; ?>.jpg" id="itemPhoto" name="itemPhoto" alt="item image" width="100" height="100">
							</div>
						</div>
					</form>
					<form action="partials/_menuManage.php" method="post">
						...
						<div class="text-left my-2 row">
							...
							<div class="form-group col-md-6">
								<b><label for="catId">toko Id</label></b>
								<input class="form-control" id="catId" name="catId" value="<?php echo $menuTokoId; ?>" type="number" min="1" required>
							</div>
						</div>
						<div class="text-left my-2">
