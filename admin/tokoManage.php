<div class="container-fluid" style="margin-top:98px">
    <div class="col-lg-12">
        <div class="row">
            <!-- FORM Panel -->
            <div class="col-md-4">
                <form action="partials/_tokoManage.php" method="post" enctype="multipart/form-data">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label class="control-label">Toko Name: </label>
                                <input type="text" class="form-control" name="name" required>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Toko Desc: </label>
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-md-12">
                                    <button type="submit" name="createToko" class="btn btn-sm btn-primary col-sm-3 offset-md-4"> Create </button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered table-hover mb-0">
                            <thead style="background-color: rgb(111 202 203);">
                                <tr>
                                    ...
                                    <th class="text-center" style="width:58%;">Toko Detail</th>
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo '<tr>
                                        ...
                                        <td><img src="/e-commerce/img/card-' . $catId . '.jpg" alt="image for this Toko" width="150px" height="150px"></td>
                                        <td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form action="partials/_tokoManage.php" method="POST">
                                                <button name="removeToko" class="btn btn-sm btn-danger" style="margin-left:9px;">Delete</button>
...
<?php
$catsql = "SELECT * FROM `toko`";
$catResult = mysqli_query($conn, $catsql);
while ($catRow = mysqli_fetch_assoc($catResult)) {
    $catId = $catRow['tokoId'];
    $catName = $catRow['tokoName'];
    $catDesc = $catRow['tokoDesc'];
?>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background-color: rgb(111 202 203);">
                    <h5 class="modal-title" id="updateCat<?php echo $catId; ?>">Toko Id: <b><?php echo $catId; ?></b></h5>
                    ...
                    <form action="partials/_tokoManage.php" method="post" enctype="multipart/form-data">
                        <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
                            ...
                            <div class="form-group col-md-4">
                                <img src="/e-commerce/img/card-<?php echo $catId; ?>.jpg" id="itemPhoto" name="itemPhoto" alt="Toko image" width="100" height="100">
                            </div>
                        </div>
                    </form>
                    <form action="partials/_tokoManage.php" method="post">
                        ...
                        <input type="hidden" id="catId" name="catId" value="<?php echo $catId; ?>">
                        <button type="submit" class="btn btn-success" name="updateToko">Update</button>
                    </form>
                </div>
            </div>
        </div>
