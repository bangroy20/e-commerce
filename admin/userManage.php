                ...
                <table class="table-striped table-bordered col-md-12 text-center">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<tr>
                                    <td>' . $Id . '</td>
                                    <td><img src="/e-commerce/img/person-' . $Id . '.jpg" alt="image for this user" onError="this.src =\'/e-commerce/img/profilePic.jpg\'" width="100px" height="100px"></td>
                                    <td>' . $username . '</td>
                                    <td>
                ...
                <div class="modal-body">
                    ...
                    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
                        ...
                        <div class="form-group col-md-4">
                            <img src="/e-commerce/img/person-<?php echo $Id; ?>.jpg" alt="Profile Photo" width="100" height="100" onError="this.src ='/e-commerce/img/profilePic.jpg'">
                            <form action="partials/_userManage.php" method="post">
                                <input type="hidden" id="userId" name="userId" value="<?php echo $Id; ?>">
                            ...
                            <div class="form-group col-md-6 my-0">
                                ...
                                <select name="userType" id="userType" class="custom-select browser-default" required>
                                    ...
                                    <?php
                                        ...
                                        <option value="0">User</option>
                                        <option value="1">Admin</option>
                                        <option value="2" selected>Penjual</option>
                                        <option value="3">Kurir</option>
                                    <?php
                                    } elseif ($userType == 3) { ?>
                                        <option value="0">User</option>
