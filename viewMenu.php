    ...
    <div class="container my-4" id="cont">
        <div class="row jumbotron">
            ...
            <div class="col-md-8 my-4">
                <h3>' . $menuName . '</h3>
                <h5 style="color: #ff0000">Rs. ' . $menuPrice . '/-</h5>
            ...
            if ($loggedin) {
                ...
                if ($quaExistRows == 0) {
                    ...
                    echo '<a href="viewCart.php?catid=' . $id . '"><button class="btn btn-primary my-2">Go to Cart</button></a>';
                }
            } else {
            ...
            echo '</form>
                ...
                <div class="mx-4">
                    <a href="viewmenuList.php?catid=' . $menuTokoId . '" class="active text-dark">
